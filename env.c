 ...
 * @info: Struct containin potential arguments used to maintain
...
/**
 * _mysetenv - starts  environment variable,
...
/**
 * _myunsetenv - delet environment variable
 * @info: Struct contain potential arguments Used to maintain
 *  constant prototype.
 * Return: always 0.
 */
 ...
 * @info: Struct containin potential argument used to maintain
 * constant prototype.
 * Return: always 0.
 */
